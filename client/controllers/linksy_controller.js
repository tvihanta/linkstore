    ...
    function(Chaplin, Controller, LinkCollection, LinksyView, MainView, FormView, TagsView, LoginView) {
    'use strict';
    ...
    var LinksyController = Controller.extend({
        ...
        show : function(params) {
            ...
            this.tagsView = new TagsView({ region:"tags", selectedItem:"all" });
        ...
        showTag : function(params) {
            ...
            this.formView = new FormView({ region:"form", collection:that.collection});
            this.tagsView = new TagsView({ region:"tags", selectedItem: params.tag });
